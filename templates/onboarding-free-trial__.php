<?php
    ...
    wp_enqueue_script('simplenursing-vue-free-trial-questions', get_stylesheet_directory_uri() . '/js/simplenursing-vue-free-trial-questions.js', ['vue-js'], rand(), true);
    wp_enqueue_style( 'onboarding-css', get_stylesheet_directory_uri() . '/css/onboarding.css', [], rand());
...
<div class="container" id="free-trial-questions">
    ...
    <div id="step1" class="step_n" v-if="step==1">
        ...
        <section class="welcome">
          <div class="welcome__title">Welcome to the <br class="d-md-none">SimpleNursing Free Trial</div>
          <div>
          ...
          <div class="col-md-8 col-12">
            ...
            <form class="form_with_icon">
              <div class="form-group">
                ...
                <label for="input_graduate_year">When do you <br class="d-md-none d-inline-block">graduate?</label>
   ...
   <div class="onboarding_progress" v-if="step<2">
      <ul v-if="step==1">
...
<!-- /main -->
    ...
    jQuery(document).ready(function ($) {
      ...
      jQuery("#input_nursing_school").on('keyup', function (e) {
      ...
      jQuery('#input_nursing_school_typeahead li').click(function () {
        jQuery("#input_nursing_school").val(jQuery(this).html());
        jQuery('#input_nursing_school_typeahead').hide();
      });
