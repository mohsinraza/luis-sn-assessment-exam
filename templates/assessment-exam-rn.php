    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>It's been {{showCountDown(this.examTimeLimitOriginal - this.examTimeLimit)}} hours since you started the exam. You should take a small break (please note, the clock won't stop)</p>
