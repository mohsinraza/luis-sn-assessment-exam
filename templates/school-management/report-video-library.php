...
wp_enqueue_script('simplenursing-vue-school-report-video-library', get_stylesheet_directory_uri() . '/js/simplenursing-vue-school-report-video-library.js', [], rand(), true);
?>


<div id="app-student-report-video-library" class="text-center">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <b-card-group deck>
                                <b-card header="Total videos watched by different students">
                                    <b-overlay
                                      :show="chartLoading"
                                      rounded
                                      opacity="0.6"
