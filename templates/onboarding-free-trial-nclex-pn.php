<?php
    ...
    wp_enqueue_script('simplenursing-vue-free-trial-teas-questions', get_stylesheet_directory_uri() . '/js/simplenursing-vue-free-trial-teas-questions.js', ['vue-js'], SN_ASSETS_VERSION, true);
    wp_enqueue_style( 'onboarding-teas-css', get_stylesheet_directory_uri() . '/css/onboarding-teas.css', [], SN_ASSETS_VERSION);
          ...
          <div class="col-md-8 col-12">
            ...
            <form class="form_with_icon">
              <div class="form-group">
                ...
                <label for="input_graduate_year">When do you <br class="d-md-none d-inline-block">plan to begin nursing school?</label>
                <div class="clearfix"></div>
                <select v-model="whenGraduateMonth" class="w-50 float-left">
                ...
                <select v-model="whenGraduateYear" class="">
