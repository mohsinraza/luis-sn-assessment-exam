            ...
            <div class="content-box" v-bind:class="{' main_step_last': step==2}">
              <div id="step1" class="step_n" v-if="step==1">
                ...
                <form class="form_with_icon">
                  ...
                  <div class="step-item d-none" id="form_group2">
                    <div class="step-icon">
                      <img src="<?php echo SN_ASSETS_URL ?>/images/onboarding/step-icon-2.svg" alt="step-icon-2">
                    </div>
                    <div>
                      <h5>Which license are you currently pursuing?</h5>
