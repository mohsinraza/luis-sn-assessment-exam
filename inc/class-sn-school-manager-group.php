<?php
/*
 * School Manager Groups from the Schools database
*/

class SN_School_Manager_Group {
    public $group_id;
    public $school_id;
    public $group_name;
    public $nclex_access;
    ...
    private function set_school_group_data() {
        ...
        $sql_result = $wpdb->get_row(
            $wpdb->prepare(
                "SELECT * FROM `sn_school_managers_groups` WHERE group_id = %d",
                $this->group_id
                )
        );
    ...
    */
    public function update_group_permissions($video_category_slugs) {
        ...
        $table = 'sn_school_managers_group_access_video';
    ...
    */
    public function update_group_instructor_restrictions_quiz_banks($video_category_slugs) {
        ...
        $table = 'sn_school_managers_group_access_quiz_banks';
        $video_category_slugs_encoded = json_encode($video_category_slugs);
    ...
    */
    public function update_group_instructor_restrictions_study_guides($video_category_slugs) {
        ...
        $table = 'sn_school_managers_group_access_study_guides';
        $video_category_slugs_encoded = json_encode($video_category_slugs);
    ...
    public function get_group_permissions() {
        ...
        $sql_result = $wpdb->get_row(
            $wpdb->prepare(
                "SELECT * FROM `sn_school_managers_group_access_video` WHERE group_id = %d",
                $this->group_id
                )
        );
    ...
    public function get_group_permissions_study_guides() {
        ...
        $sql_result = $wpdb->get_row(
            $wpdb->prepare(
                "SELECT * FROM `sn_school_managers_group_access_study_guides` WHERE group_id = %d",
                $this->group_id
                )
        );
    ...
    */
    public function update_group_permissions_study_guides($study_guides_category_slugs) {
        ...
        public function get_group_permissions_quiz_banks() {
            ...
            $sql_result = $wpdb->get_row(
                $wpdb->prepare(
                    "SELECT * FROM `sn_school_managers_group_access_quiz_banks` WHERE group_id = %d",
                    $this->group_id
                    )
            );
        ...
        */
        public function update_instructors_group_nclex_permissions($nclex_access) {
            global $wpdb;
